...
def add_default_jobs(bot):
    scheduler.add_job(d_rems.morning_plan, trigger='cron', day_of_week=days, hour='9', minute='30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.morning_plan, trigger='cron', day_of_week=days, hour='10-21', minute='0,30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.brigade_report, trigger='cron', day_of_week=days, hour='10-21', minute='0,30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    #scheduler.add_job(d_rems.night_payment, trigger='cron', day_of_week=days, hour='13-21', minute='0,30',
    #                  start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.day_payment, trigger='cron', day_of_week=days, hour='17-21', minute='0,30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.evening_plan, trigger='cron', day_of_week=days, hour='17', minute='30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.evening_plan, trigger='cron', day_of_week=days, hour='19-21', minute='0,30',
                      start_date=datetime.now(), kwargs={'bot': bot})
    #scheduler.add_job(d_rems.tomorrow_plan, trigger='cron', day_of_week=days, hour='18', minute='30',
    #                  start_date=datetime.now(), kwargs={'bot': bot})
    #scheduler.add_job(d_rems.tomorrow_plan, trigger='cron', day_of_week=days, hour='19-21', minute='0,30',
    #                  start_date=datetime.now(), kwargs={'bot': bot})
    scheduler.add_job(d_rems.requests_table, trigger='cron', day_of_week=days, hour='11-21/3', minute='0',
                      start_date=datetime.now(), kwargs={'bot': bot})
...
def add_dev_jobs(bot):
    #scheduler.add_job(d_rems.requests_table, trigger='cron', day_of_week=days, minute='*',
    #                  start_date=datetime.now(), kwargs={'bot': bot})
